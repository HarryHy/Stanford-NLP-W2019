...
def naiveSoftmaxLossAndGradient(
    ...
    pred = softmax(z.reshape(-1)).reshape(-1,1)
    ...
    gradCenterVec = np.dot(outsideVectors.T, delta) # (V, 1)

    gradOutsideVecs = np.dot(delta, centerWordVec.T) # (N, V)
